...
export const loadEntity = async (typeName: string, typeIRI: string, entityIRI: string, schema: JSONSchema7) => {
...
export const findEntities = async (typeName: string, amount: number, schema: JSONSchema7, search?: string) => {
