...
const exampleAllProps = {
  ...
  'depiction': [
    {
      'thumbnail': 'https://commons.wikimedia.org/wiki/Special:FilePath/D15%20-%20ruruHaus%202022-06-16.JPG?width=270',
...
export const LobidAllPropTableDefault = () => <LobidAllPropTable allProps={exampleAllProps} />
