// To parse this data:
//
//   import { MarcResponseConvert, SearchRetrieveResponseTypes } from "./file";
//
//   const searchRetrieveResponseTypes = MarcResponseConvert.toSearchRetrieveResponseTypes(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface MarcResponseTypes {
  "?xml": XML;
...
/**
 * Convert JSON to SearchRetrieveResponseTypes and vice versa
 */
export class MarcResponseConvert {
  /**
   * Converts a JSON string to a SearchRetrieveResponseTypes and assert the result
   * @param json
   */
  public static toSearchRetrieveResponseTypes(json: string): MarcResponseTypes {
    return cast(JSON.parse(json), r("SearchRetrieveResponseTypes"));
  }

  public static searchRetrieveResponseTypesToJson(
    value: MarcResponseTypes,
  ): string {
    return JSON.stringify(
      uncast(value, r("SearchRetrieveResponseTypes")),
      null,
      2,
    );
  }
...
const typeMap: any = {
  SearchRetrieveResponseTypes: o(
    [
      { json: "?xml", js: "?xml", typ: r("XML") },
      {
        ...
        js: "searchRetrieveResponse",
        typ: r("SearchRetrieveResponse"),
      },
    ],
    false,
  ),
  ...
  SearchRetrieveResponse: o(
    [
      ...
      {
        json: "echoedSearchRetrieveRequest",
        js: "echoedSearchRetrieveRequest",
        typ: r("EchoedSearchRetrieveRequest"),
      },
    ],
    false,
  ),
    ...
    [
      {
        json: "subfield",
        js: "subfield",
        typ: u(a(r("SubfieldElement")), r("SubfieldElement")),
      },
      { json: "@_tag", js: "@_tag", typ: "" },
  ...
  Leader: ["caa a22     2  4500", "cam a22     2  4500", "naa a22     2  4500"],
};
