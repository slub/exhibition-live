...
export const getI18nDescription: (defaultValue: string | null, translator: Translator, element: UISchemaElement, path: string, resolvedSchema?: JsonSchema) => string | undefined =
  (...arg) => i18nHelper('description', ...arg)

export const getI18nLabel: (defaultValue: string | null, translator: Translator, element: UISchemaElement, path: string, resolvedSchema?: JsonSchema) => string | undefined =
  (...arg) => i18nHelper('label', ...arg)
