...
export const EntityDetailModal = NiceModal.create(({typeIRI, entityIRI}: EntityDetailModalProps) => {
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <EntityDetailCard typeIRI={typeIRI} entityIRI={entityIRI} data={data} cardInfo={cardInfo}/>
      </DialogContent>
      <DialogActions>
