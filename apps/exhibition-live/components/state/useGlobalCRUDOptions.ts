...
export const useGlobalCRUDOptions: UseGlobalCRUDOptions = () => {
  ...
  const [localWorkerCRUDOptions, setLocalWorkerCRUDOptions] = useState<
    CRUDFunctions | undefined
  >();
    ...
    setCrudOptions(
      activeEndpoint &&
        (activeEndpoint.endpoint === "urn:worker"
          ...
          ? allegroCrudOptions(activeEndpoint)
          : oxigraphCrudOptions(activeEndpoint)),
    );
  }, [
    localWorkerCRUDOptions,
