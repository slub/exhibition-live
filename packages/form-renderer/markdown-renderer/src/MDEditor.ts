    ...
    const promise:
      | Promise<
          React.ForwardRefExoticComponent<
            MDEditorProps & React.RefAttributes<ContextStore>
          > & {
            Markdown: React.ForwardRefExoticComponent<
              MarkdownPreviewProps & React.RefAttributes<MarkdownPreviewRef>
            >;
          }
        >
      | LoaderComponent<MDEditorProps & React.RefAttributes<ContextStore>> =
