// To parse this data:
//
//   import { MappingConvert, Types } from "./file";
//
//   const types = MappingConvert.toTypes(json);
//
...
const typeMap: any = {
  Types: o([{ json: "tags", js: "tags", typ: r("Tags") }], false),
  Tags: o(
    [
      ...
      {
        json: "^5(?!03|20|21|46|71|72|73|74|90|92|95|99)",
        js: "^5(?!03|20|21|46|71|72|73|74|90|92|95|99)",
        typ: r("The5032021467172737490929599"),
      },
  ...
  The008: o(
    [
      ...
      {
        json: "cataloguingDate",
        js: "cataloguingDate",
        typ: r("CataloguingDate"),
      },
  ...
  AudienceObject: o(
    [
      ...
      {
        json: "regex_substitute",
        js: "regex_substitute",
        typ: u(undefined, r("PurpleRegexSubstitute")),
      },
  ...
  ContentCodeObject: o(
    [
      ...
      { json: "substr_length", js: "substr_length", typ: 0 },
      {
        json: "regex_substitute",
        js: "regex_substitute",
        typ: r("TentacledRegexSubstitute"),
      },
      { json: "datatype", js: "datatype", typ: r("Datatype") },
  ...
  LanguageRelation: o([{ json: "class", js: "class", typ: "" }], false),
  The015: o(
    [{ json: "subfield", js: "subfield", typ: r("The015_Subfield") }],
    false,
  ),
  The015_Subfield: o([{ json: "a", js: "a", typ: r("PurpleA") }], false),
  PurpleA: o(
    [
      { json: "object", js: "object", typ: r("TitleNumberObject") },
  ...
  PurpleSubfield: o([{ json: "b", js: "b", typ: r("PurpleB") }], false),
  PurpleB: o(
    [
  ...
  PurpleObject: o(
    [
      ...
      { json: "regex_split", js: "regex_split", typ: u(undefined, "") },
      {
        json: "regex_substitute",
        js: "regex_substitute",
        typ: u(undefined, r("StickyRegexSubstitute")),
      },
  ...
  FluffyObject: o(
    [
      ...
      { json: "regex_split", js: "regex_split", typ: u(undefined, "") },
      {
        json: "regex_substitute",
        js: "regex_substitute",
        typ: u(undefined, r("IndigoRegexSubstitute")),
      },
      {
        json: "regex_strip",
        js: "regex_strip",
        typ: u(undefined, r("RegexStrip")),
      },
      { json: "urlize", js: "urlize", typ: u(undefined, true) },
    ],
    false,
  ...
  TentacledObject: o(
    [
      ...
      { json: "regex_split", js: "regex_split", typ: u(undefined, "") },
      {
        json: "regex_substitute",
        js: "regex_substitute",
        typ: u(undefined, r("IndecentRegexSubstitute")),
      },
      {
        json: "regex_strip",
        js: "regex_strip",
  ...
  StickyObject: o(
    [
      ...
      { json: "regex_split", js: "regex_split", typ: "" },
      {
        json: "regex_substitute",
        js: "regex_substitute",
        typ: r("HilariousRegexSubstitute"),
      },
    ],
    false,
  ),
  ...
  The022_Subfield: o([{ json: "a", js: "a", typ: r("BClass") }], false),
  The041: o(
  ...
  The082_Subfield: o([{ json: "a", js: "a", typ: r("StickyA") }], false),
  StickyA: o(
    [
      { json: "object", js: "object", typ: r("PObject") },
  ...
  The092_Subfield: o([{ json: "a", js: "a", typ: r("TitleNumber") }], false),
  The100: o(
    [{ json: "subfield", js: "subfield", typ: r("The100_Subfield") }],
    false,
  ),
  The100_Subfield: o([{ json: "3", js: "3", typ: r("Purple3") }], false),
  Purple3: o(
    [
      { json: "predicate", js: "predicate", typ: "" },
  ...
  The110_Subfield: o([{ json: "3", js: "3", typ: r("Fluffy3") }], false),
  Fluffy3: o(
    [
      { json: "predicate", js: "predicate", typ: "" },
      { json: "object", js: "object", typ: r("IndecentObject") },
  ...
  The130730_Subfield: o([{ json: "3", js: "3", typ: r("Tentacled3") }], false),
  Tentacled3: o(
    [
      { json: "predicate", js: "predicate", typ: "" },
      { json: "object", js: "object", typ: r("IndigoObject") },
  ...
  The240_Subfield: o([{ json: "a", js: "a", typ: r("IndecentA") }], false),
  IndecentA: o(
    [
      { json: "object", js: "object", typ: r("PObject") },
  ...
  The240240_Subfield: o([{ json: "a", js: "a", typ: r("HilariousA") }], false),
  HilariousA: o(
    [
  ...
  The245245_Subfield: o([{ json: "a", js: "a", typ: r("UClass") }], false),
  UClass: o(
    [
      { json: "predicate", js: "predicate", typ: "" },
      { json: "object", js: "object", typ: r("UObject") },
  ...
  IndigoSubfield: o([{ json: "b", js: "b", typ: r("TitleNumber") }], false),
  The300: o(
  ...
  The600_Subfield: o([{ json: "t", js: "t", typ: r("T") }], false),
  T: o(
    [
      { json: "predicate", js: "predicate", typ: "" },
  ...
  The630_Subfield: o([{ json: "3", js: "3", typ: r("Indecent3") }], false),
  Indecent3: o(
    [
      { json: "predicate", js: "predicate", typ: "" },
      { json: "object", js: "object", typ: r("IndecentObject") },
  ...
  The650650_Subfield: o([{ json: "a", js: "a", typ: r("CunningA") }], false),
  CunningA: o(
    [
      { json: "predicate", js: "predicate", typ: "" },
      { json: "object", js: "object", typ: r("UObject") },
  ...
  The651_Subfield: o([{ json: "3", js: "3", typ: r("Hilarious3") }], false),
  Hilarious3: o(
    [
      { json: "predicate", js: "predicate", typ: "" },
      { json: "object", js: "object", typ: r("IndecentObject") },
  ...
  The652_Subfield: o([{ json: "3", js: "3", typ: r("Ambitious3") }], false),
  Ambitious3: o(
    [
      { json: "predicate", js: "predicate", typ: "" },
      { json: "object", js: "object", typ: r("IndecentObject") },
  ...
  The695_Subfield: o([{ json: "a", js: "a", typ: r("MischievousA") }], false),
  MischievousA: o(
    [
      { json: "predicate", js: "predicate", typ: "" },
      { json: "object", js: "object", typ: r("PurpleObject") },
  ...
  The699_Subfield: o([{ json: "a", js: "a", typ: r("BraggadociousA") }], false),
  BraggadociousA: o(
    [
      { json: "predicate", js: "predicate", typ: "" },
      { json: "object", js: "object", typ: r("AmbitiousObject") },
  ...
  The700_Subfield: o([{ json: "3", js: "3", typ: r("Cunning3") }], false),
  Cunning3: o(
    [
  ...
  MischievousSubfield: o([{ json: "e", js: "e", typ: r("FluffyE") }], false),
  FluffyE: o(
    [
      { json: "default", js: "default", typ: "" },
  ...
  The710_Subfield: o([{ json: "3", js: "3", typ: r("Magenta3") }], false),
  Magenta3: o(
    [
      { json: "predicate", js: "predicate", typ: "" },
      { json: "object", js: "object", typ: r("IndecentObject") },
  ...
  The740_Subfield: o([{ json: "a", js: "a", typ: r("A1") }], false),
  A1: o(
    [
      { json: "object", js: "object", typ: r("TitleNumberObject") },
  ...
  The760_Subfield: o([{ json: "w", js: "w", typ: r("S") }], false),
  The856: o(
    [{ json: "subfield", js: "subfield", typ: r("The856_Subfield") }],
    false,
  ),
  The856_Subfield: o([{ json: "u", js: "u", typ: r("UClass") }], false),
  The5032021467172737490929599: o(
    [
      {
        json: "subfield",
        js: "subfield",
        typ: r("The5032021467172737490929599_Subfield"),
      },
    ],
    false,
  ),
  ...
  RegexStrip: ["^.*?(?=http)", "[\\W]+"],
  Combinestring: [" - ", ". "],
  Class: ["FABIO.Work", "SKOS.Concept", "YAGO.LiteraryGenres"],
};
