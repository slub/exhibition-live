...
export type AllExhibitionsQuery = {
  __typename?: "Query";
  getExhibitions: Array<{
    ...
    places?: Array<{
      __typename?: "PlaceType";
      title: string;
      location?: { __typename?: "LocationType"; id: any; title: string } | null;
    }> | null;
    locations?: Array<{
      __typename?: "LocationType";
      id: any;
...
export type SearchExhibitionsQuery = {
  __typename?: "Query";
  getExhibitions: Array<{
    __typename?: "ExhibitionType";
    id: any;
...
>(
  ...
  useQuery<AllExhibitionsQuery, TError, TData>(
    variables === undefined
      ? ["allExhibitions"]
      : ["allExhibitions", variables],
    useFetchData<AllExhibitionsQuery, AllExhibitionsQueryVariables>(
...
>(
  ...
  useQuery<SearchExhibitionsQuery, TError, TData>(
    variables === undefined
      ? ["searchExhibitions"]
      : ["searchExhibitions", variables],
    useFetchData<SearchExhibitionsQuery, SearchExhibitionsQueryVariables>(
      SearchExhibitionsDocument,
    ).bind(null, variables),
    options,
  );
export const AllPersonsDocument = `
  ...
  getPersons {
    ...
    `;
export const useAllPersonsQuery = <TData = AllPersonsQuery, TError = unknown>(
  ...
  useQuery<AllPersonsQuery, TError, TData>(
    ...
    useFetchData<AllPersonsQuery, AllPersonsQueryVariables>(
      AllPersonsDocument,
    ).bind(null, variables),
    options,
  );
