  ...
  const handleRemoveItem = useCallback(
    (p: string, value: number) => () => {
      ...
      setSelectedIndex((prev) =>
        !prev || prev === value ? undefined : prev > value ? prev - 1 : prev,
      );
    },
      ...
      <Grid container direction={matches ? "row" : "column"} spacing={2}>
          ...
          {matches ? (
            ...
            <Grid container direction={"row"}>
              <Select
                ...
                value={
                  selectedIndex === undefined ? "" : selectedIndex.toString()
                }
        ...
        <Grid item xs>
          {selectedIndex !== undefined ? (
            ...
            <FormHelperText>
              {dataLength > 0 ? t("choose_or_add") : t("no_entry_add")}
            </FormHelperText>
          )}
          <Button
            endIcon={<Add />}
          ...
          >
            {t(dataLength > 0 ? "add_another" : "add_first", { item: label })}
          </Button>
        </Grid>
      </Grid>
    </Hidden>
